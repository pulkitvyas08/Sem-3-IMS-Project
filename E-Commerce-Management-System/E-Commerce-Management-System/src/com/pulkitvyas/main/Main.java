package com.pulkitvyascoder.main;
...
public class Main extends Application {
    ...
    private void loginWindow(Stage stage) {
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/com/pulkitvyascoder/views/LoginView.fxml"));
            Scene scene = new Scene(root);
            stage.initStyle(StageStyle.UNDECORATED);
            stage.setScene(scene);
            stage.setTitle("E-Commerce Management System");
    ...
    private void startWindow(Stage stage) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/pulkitvyascoder/views/StartView.fxml"));
            Scene scene = new Scene(root);
            stage.initStyle(StageStyle.UNDECORATED);
            stage.setScene(scene);
